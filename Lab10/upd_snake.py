...
apple = pygame.image.load('/Users/nuraiaitbazar/Desktop/pp2/files/apple.png').convert_alpha()#getting apple image
golden = pygame.image.load('/Users/nuraiaitbazar/Desktop/pp2/files/goldapple.png').convert_alpha()
...
if __name__ == "__main__":
    create_high_scores_table()  # Ensure this is called before game starts
    main_game = Main()  # Start game after ensuring table exists
