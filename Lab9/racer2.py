...
background = pygame.image.load("/Users/nuraiaitbazar/Desktop/pp2/files/AnimatedStreet.png")
...
# background sound
pygame.mixer.music.load('/Users/nuraiaitbazar/Desktop/pp2/files/bg_sound.mp3')
pygame.mixer.music.play(-1) # i use -1 to loop the music

class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/nuraiaitbazar/Desktop/pp2/files/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/nuraiaitbazar/Desktop/pp2/files/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/nuraiaitbazar/Desktop/pp2/files/coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
...
class BigCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('/Users/nuraiaitbazar/Desktop/pp2/files/bigcoin.png')
        self.rect = self.image.get_rect()
    def move(self):
        self.rect.move_ip(0, SPEED)
